...
Le meilleur moyen d'utiliser les feature flags selon moi, c'est au runtime. Grace a des outils comme [Progressively](https://progressively.app), il est possible, simplement et en un click, d'activer en temps reel une fonctonalites a vos utilisateurs.

<FeatureFlagExample client:only />

Et dans le code, selon la solution choisie, ca ressemblerait a ca :
