...
Pour comprendre le processus dans sa globalité, repartons du serveur. Dans les frameworks actuels, le serveur utilise pour générer le HTML est **un serveur Node.js**.
